...
import 'package:appliances_flutter/controllers/success_model.dart';
  ...
  void registrationFunction(String data) async {
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        Get.snackbar("Bạn đã đăng ký thành công", data.message,
        ...
        Get.snackbar("Không đăng ký được", error.message,
            colorText: kLightWhite,
